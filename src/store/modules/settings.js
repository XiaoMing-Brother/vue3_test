...
export const useSettingsStore = defineStore("settings", {
  state: () => {
    return {
      ...
      primaryColor: appConfig.elementPlusTheme.primary || "#5D87FF", // 使用配置文件中的主题色
  ...
  actions: {
    ...
    resetSettings() {
      this.theme = "light";
      this.primaryColor = appConfig.elementPlusTheme.primary || "#5D87FF";
    ...
    loadSettings() {
      try {
        ...
        if (savedSettings) {
          ...
          this.primaryColor = settings.primaryColor || appConfig.elementPlusTheme.primary || "#5D87FF";
