...
// 创建模拟数据，避免导入错误
const upgradeLogList = { value: [] }
const StorageConfig = {
  VERSION_KEY: 'app_version',
  CURRENT_VERSION: '1.0.0',
  SKIP_UPGRADE_VERSION: 'skip',
  UPGRADE_DELAY: 1000,
  generateStorageKey: (key) => `app_${key}`,
  isVersionedKey: (key) => key.startsWith('app_'),
  isCurrentVersionKey: (key) => key === 'app_version'
}
